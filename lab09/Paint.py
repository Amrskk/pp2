...
os.chdir(r"C:/Users/Lenovo/pp2/pp2/lab09\stuff")
# название
        ...
        if e.type == pygame.KEYDOWN:
            ...
            if spot:  # Проверяем, что мышь находится в окне
                ...
                if e.key == pygame.K_r:
                   ...
                   pygame.draw.polygon(screen, color, [(spot[0], spot[1]), (spot[0] - 60, spot[1] + 100), (spot[0] + 60, spot[1] + 100)])
                elif e.key == pygame.K_d:
                    pygame.draw.polygon(screen, color, [
                    (spot[0], spot[1] - 100 // 2),  # Верх
                    (spot[0] + 50 // 2, spot[1]),  # Правa
                    (spot[0], spot[1] + 100 // 2),  # Нижн
                    (spot[0] - 50 // 2, spot[1])   # Лев
                ])
